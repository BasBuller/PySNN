...
def showTD(TD, frameRate=24, preComputeFrames=True, repeat=False):
    ...
    '''
    if TD.dim == 1:
        anim = _showTD1D(TD, frameRate=frameRate, preComputeFrames=preComputeFrames, repeat=repeat)		
    else:
        anim = _showTD2D(TD, frameRate=frameRate, preComputeFrames=preComputeFrames, repeat=repeat)
    return anim
